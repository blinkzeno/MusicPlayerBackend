...
const { uploadMusic, getAllMusics, getMusic, deleteMusic, updateMusic, searchMusic, getMusicsByUser } = require('../controllers/MusicController');  // Importation des contrôleurs pour les actions liées aux musiques
